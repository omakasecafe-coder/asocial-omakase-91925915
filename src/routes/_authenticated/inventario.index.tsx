...
import { recordInventoryWaste, saveInventoryLot } from "@/lib/inventory.functions";
import {
  asNumber,
  daysUntil,
  itemById,
      ...
      <div className="mt-8 grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
        <section className="overflow-x-auto rounded-xl border border-border bg-card">
          ...
          <div className="divide-y divide-border">
            {lots.length === 0 ? (
              <p className="p-5 text-sm text-muted-foreground">Aun no hay lotes registrados.</p>
            ) : (
              lots.map((lot) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-muted-foreground">{lot.lot_code || "Sin codigo"}</span>
        ...
        <aside className="space-y-6">
          <div className="card-soft p-5">
            ...
            <div className="mt-5 space-y-4">
              ...
              <div>
                <Label className="text-xs text-muted-foreground">Codigo de lote</Label>
                <Input
                  className="mt-2"
